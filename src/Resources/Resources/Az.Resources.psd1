...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Marked ''ObjectType'' as ''Unknown'' if object is not found or current account has insufficient privileges to get object type for role assignment [#16981]
